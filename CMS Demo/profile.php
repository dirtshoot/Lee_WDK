...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$Page_Title = "WDK - Profile";
	$Page_Content = "<iframe name='iframe' height='400px' width='800px'frameborder='0' src='".$Datafeed_Dir."/Datafeed_Profile.php?id=".$profile_id."' scrolling='auto' border='0' allowtransparency='true'></iframe>";
